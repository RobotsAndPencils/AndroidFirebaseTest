...
public class LocalFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Timber.d("Firebase notification From: %s", remoteMessage.getFrom());
        Timber.d("Firebase notification message body: %s", remoteMessage.getNotification().getBody());
     ...
     */
    private void sendNotification(final String title, String messageBody) {
